...
class WebViewScreen extends StatefulWidget {
  final Item notice;
  const WebViewScreen({super.key, required this.notice});
...
class _WebViewScreenState extends State<WebViewScreen> {
  ...
  late Item notice = widget.notice;
  ...
  void initState() {
    ...
    var urlNotice = notice.url
        .replaceFirst('https://www.notion.so', 'https://radiorcv.notion.site');

    controller
      ..setJavaScriptMode(JavaScriptMode.unrestricted)
      ..setBackgroundColor(const Color(0x00000000))
      ..loadRequest(Uri.parse(urlNotice));
